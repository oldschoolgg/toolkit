import type { APIApplicationCommandOptionChoice, APIInteractionDataResolvedChannel, APIInteractionDataResolvedGuildMember, APIRole, ApplicationCommandOptionType, BaseInteraction, Channel, ChatInputCommandInteraction, Client, GuildMember, Role, User } from 'discord.js';
...
export type CommandOption = {
    ...
    autocomplete?: (value: string, user: User, member?: GuildMember) => Promise<APIApplicationCommandOptionChoice[]>;
} | {
    ...
    autocomplete?: (value: number, user: User, member?: GuildMember) => Promise<APIApplicationCommandOptionChoice[]>;
    min_value?: number;
    max_value?: number;
} | {
